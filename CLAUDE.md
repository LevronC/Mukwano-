...
**Core Value:** Governance enforced in the server layer, not the UI — every balance mutation, vote count, and permission check happens in the API, making the system trustworthy by construction.
